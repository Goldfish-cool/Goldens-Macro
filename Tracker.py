                    ...
                    json.dump(
                        {
                            ...
                            "biome_alerts": {
                                "WINDY": config.config_data['biomes']['Windy'],
                                "RAINY": config.config_data['biomes']['Rainy'],
                                "SNOWY": config.config_data['biomes']['Snowy'],
                                "SAND STORM": config.config_data['biomes']['Sandstorm'],
                                "HELL": config.config_data['biomes']['Hell'],
                                "STARFALL": config.config_data['biomes']['Starfall'],
                                "CORRUPTION": config.config_data['biomes']['Corruption'],
                                "NULL": config.config_data['biomes']['Null'],
                            },
                        },
                        f,
                        indent=2,
