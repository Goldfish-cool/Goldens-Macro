...
class MainWindow(CTk):
    def __init__(self, config_key=None):
        ...
        enable_biome = CTkCheckBox(master=biome_config, text="Enabled Biome Dectection").grid(row=2, column=0, padx=5, pady=5, stick="w")
        set_region = CTkButton(master=biome_config, text="Set Biome Region").grid(row=3, column=0, padx=5, pady=5, stick="w")
